...
const float b_gyr_x = 0.41;
const float b_gyr_y = 0.72;
const float b_gyr_z = -0.45;

// IMU accelerator offsets and gains
const float b_acc_x = -17.5; // offset
const float b_acc_y = -350;
const float b_acc_z = -170;
const float f_acc_x = 1673.5; // gain
const float f_acc_y = 1674.8;
const float f_acc_z = 1689.6;
